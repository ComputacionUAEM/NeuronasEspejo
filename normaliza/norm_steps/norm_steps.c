/*
 *  norm_steps.c
 *  Normaliza los datos para la red, considerando velocidades como
 *  una funcion escalonada de 7 intervalos
 *
...
int main(int argc, char *argv[]){
  ...
  if (argc!=4) {
    ...
    printf("\tdonde src es el archivo con los datos de entrada,\n");
    printf("\tdst es la salida con los datos normalizados\n");
    printf("\ty src2 es el archivo src pero sin perdida de marcador\n");
    return 1;
  }
  float t[4],t1[4],mv[3];
  ...
  if (nombre == NULL){
	...
	if(t[2]>=0&&t1[2]>=0&&t[3]>=0&&t[3]<=180&&t1[3]>=0&&t1[3]<=180){
	  ...
	  fprintf(dst,"%f %f ",((mv[0]*mv[2])+18000)/36000,((mv[1]*mv[2])+18000)/36000);
	  fprintf(dst,"%f %f %f\n",(t1[0]+770)/1540,(t1[1]+250)/500,t1[2]/2700);
