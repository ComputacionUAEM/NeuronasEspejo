  ...
  if (nombre == NULL){
	...
	if(t[2]>=0&&t1[2]>=0&&t[3]>=0&&t[3]<=180&&t1[3]>=0&&t1[3]<=180){
	  fprintf(src,"%f %f %f %f ",t[0],t[1],t[2],t[3]);
          ...
          fprintf(src,"%f %f %f\n",mv[0],mv[1],mv[2]);
          fprintf(dst,"%f %f %f %f ",(t[0]+770)/1540,(t[1]+250)/500,t[2]/2700,t[3]/180);
	  fprintf(dst,"%f %f ",(mv[0]*mv[2]+180000)/360000,(mv[1]*mv[2]+180000)/360000);
	  fprintf(dst,"%f %f %f %f\n",(t1[0]+770)/1540,(t1[1]+250)/500,t1[2]/2700,t1[3]/180);
